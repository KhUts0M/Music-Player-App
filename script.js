...
var repeatBtn = document.querySelector("#repeat i"); // Add this line
var index = 0;
var img = document.querySelector(".img img");
var isRepeat = false; // Add this line
...
function toggleRepeat() {
  ...
  song.loop = !song.loop; // Toggle the loop property
  var repeatButton = document.getElementById("repeat");

  // Update the button icon based on the loop state
  if (song.loop) {
